...
import { Settings, Cog, Shield, Globe } from "lucide-react"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h1 className="dashboard-title warm-text-primary">Platform Settings</h1>
                    <p className="warm-text-secondary">System configuration and preferences</p>
                  </div>
                </div>
              </div>
                ...
                <CardContent className="space-y-6">
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                      Comprehensive platform settings including system configuration, 
                      feature toggles, and integration management are in development.
                    </p>
