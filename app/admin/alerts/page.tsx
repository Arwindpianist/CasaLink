            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h1 className="dashboard-title warm-text-primary">Alerts & Logs</h1>
                    <p className="warm-text-secondary">System alerts and activity logs</p>
                  </div>
                </div>
              </div>
              ...
              <Card className="warm-card">
                <CardHeader>
                  ...
                  <CardDescription className="warm-text-secondary">
                    System alerts and logging features coming soon
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                      Advanced alerting system including real-time notifications, log aggregation, 
                      and automated incident response are in development.
                    </p>
